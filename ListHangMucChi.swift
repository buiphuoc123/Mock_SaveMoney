...
class ListHangMucChi
{
    ...
    private class func Anuong() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Ăn uống", imageName: "anuong", hangmuc: hangmuc)
    ...
    private class func Dichvusinhhoat() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Dịch vụ sinh hoạt", imageName: "dvsinhhoat", hangmuc: hangmuc)
    ...
    private class func Dilai() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Đi lại", imageName: "dilai", hangmuc: hangmuc)
    ...
    private class func Concai() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Con cái", imageName: "concai", hangmuc: hangmuc)
    ...
    private class func Trangphuc() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Trang phục", imageName: "trangphuc", hangmuc: hangmuc)
    ...
    private class func Hieuhi() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Hiếu hỉ", imageName: "hieuhi", hangmuc: hangmuc)
    ...
    private class func Suckhoe() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Sức khoẻ", imageName: "suckhoe", hangmuc: hangmuc)
    ...
    private class func Nhacua() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Nhà cửa", imageName: "nhacua", hangmuc: hangmuc)
    ...
    private class func Huongthu() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Hưởng thụ", imageName: "huongthu", hangmuc: hangmuc)
    ...
    private class func Phattrien() -> ListHangMucChi
    {
        ...
        return ListHangMucChi(name: "Phát triển bản thân", imageName: "phattrien", hangmuc: hangmuc)
